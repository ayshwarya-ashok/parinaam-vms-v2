...
export class TemplateService implements OnModuleInit {
  ...
  private readonly subjects: Record<string, string> = {
    ...
    enrollment_removed: 'About your enrollment — {{eventName}}',
    ...
    welcome_back: 'Welcome back to Parinaam, {{firstName}}!',
    corporate_invite: 'Volunteer with Parinaam Foundation',
    sponsor_thank_you: 'Thank you — {{eventName}}',
