...
const MATRIX = [
  ...
  ['POST',   '/feedback',                               'D', 'A', 'D'],
  ['POST',   `/feedback/${UUID}/photos`,                'D', 'A', 'D'],
  ...
  ['POST',   '/volunteers/invite',                       'D', 'D', 'A'],
  ['GET',    '/volunteers/import-template',              'D', 'D', 'A'],
  ['POST',   '/volunteers/import',                       'D', 'D', 'A'],
  ['POST',   '/volunteers/admin-create',                 'D', 'D', 'A'],
  ['POST',   `/volunteers/${UUID}/welcome-back`,        'D', 'D', 'A'],
  ['POST',   `/events/${UUID}/sponsor-pack`,            'D', 'D', 'A'],
