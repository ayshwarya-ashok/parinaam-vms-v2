...
-- -----------------------------------------------------------------------------
-- Training materials (metadata only; files are placeholders)
-- -----------------------------------------------------------------------------
...
FROM (VALUES
  ...
  ('t1','Welcome to Parinaam.pptx',            'ppt','seed/t1-welcome.pptx',   '5.7 MB', NULL, 18,   NULL, 2),
  ...
  ('t2','Emergency Response Video.mp4',        'vid','seed/t2-response.mp4',   '120 MB', NULL, NULL, '28 min', 3),
  ('t3','Child Safeguarding Policy.pdf',       'pdf','seed/t3-policy.pdf',     '2.1 MB', 32,  NULL, NULL, 1),
  ('t3','Recognition & Reporting Guide.docx',  'doc','seed/t3-reporting.docx', '0.8 MB', 12,  NULL, NULL, 2),
  ('t4','Outreach Techniques.pptx',            'ppt','seed/t4-outreach.pptx',  '6.3 MB', NULL, 22,   NULL, 1),
  ...
  ('tc2','ICC Procedures & Timelines.docx',    'doc','seed/tc2-icc.docx',      '0.9 MB', 14,  NULL, NULL, 2),
